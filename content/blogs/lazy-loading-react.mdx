export const metadata = {
  title: "Lazy loading and code spiliting in React",
  publishDate: "2025-04-19",
  description: "Lazy loading and code spiliting in React",
  category: "React",
};

By the time I write this, I have deleted a handful of blogs or decided not to publish them because of a simple reason, they became long and boring. I believe no one wants to read such blogs, including me, so I will try to keep everything short, precise, and direct to the point.
